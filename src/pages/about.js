...
// const [visibilityArray, setvisibility] = useState([{PersonalDetailsIsVisible: false},{educationIsVisible: false}])
            ...
            <div className={styles.miniContainer}>
                <div className={styles.cardContainer}>
                    ...
                    <div className={ `${styles.PersonalDetails} ${styles.card} ${styles.item1}`}>
                        ...
                        <h1 className={styles.PersonalHeader} onClick={()=>setPersonalDetailsIsVisible(!PersonalDetailsIsVisible)}>Personal details</h1>
                        <div className={PersonalDetailsIsVisible === true ?  ` ${styles.cardContent} ` : `${styles.hideCardContent}`}>
                            ...
                            {/* <div className={`${styles.address} ${styles.allCardItems}`}> <p className={styles.item}>Address</p> <p className={styles.value}>Kemphoekstraat 38, 9150 Bazel</p></div> */}
                    ...
                    <div className={`${styles.education} ${styles.card}  ${styles.item2}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setEducationIsVisible(!educationIsVisible)}>Education</h1>
                    ...
                    <div className={`${styles.education} ${styles.card}  ${styles.item3}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setEducationInIsVisible(!educationInIsVisible)}>Education institutes</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card} ${styles.item4}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setProgrammingknowledgeIsVisible(!ProgrammingknowledgeIsVisible)}>Programming knowledge</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card} ${styles.item5}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setProgrammingToolsIsVisible(!ProgrammingToolsIsVisible)}>Programming tools skills</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card} ${styles.item6}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setLanguageKnowledge(!LanguageKnowledgelsIsVisible)}>Languages knowledge</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card}  ${styles.item7}`}>
                        <h1 className={styles.PersonalHeader} onClick={()=>setWorkExperienceIsVisible(!workExperienceIsVisible)}>Work experience</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card}  ${styles.item8}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setCompetences(!competencesIsVisible)}>Competences</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card} ${styles.item9}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setCertificates(!certificatesIsVisible)}>Diploma and certificates</h1>
                    ...
                    <div className={`${styles.PersonalDetails} ${styles.card} ${styles.item10}`}>
                        <h1 className={styles.PersonalHeader}  onClick={()=>setHobbies(!hobbiesIsVisible)}>Hobbies</h1>
